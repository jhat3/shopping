...
products[0] = new Product("001", "Baseball Signed by Babe Ruth",  199999.99);
products[1] = new Product("002", "Hat Signed by David Ortiz",    499.99);
products[2] = new Product("003", "Bat Signed by Derek Jeter",  1499.99);
products[3] = new Product("004", "Jersey Signed by Matt Harvey",  599.99);
products[4] = new Product("005", "Glove Signed by Mike Trout",  599.99);
products[5] = new Product("006", "Gloves Signed by Alex Rodriguez",  699.99);
products[6] = new Product("007", "Basketball Signed by Kevin Durant",  549.99);
products[7] = new Product("008", "Shoes Signed by Kobe Bryant",  9999.99);
products[8] = new Product("009", "Jersey Signed by Lebron James",  1499.99);
products[9] = new Product("010", "Basketball Signed by Larry Bird",  349.99);
products[10] = new Product("011", "Shoes Signed by Steph Curry",  899.99);
products[11] = new Product("012", "Jersey Signed by Michael Jordan",  2499.99);
products[12] = new Product("013", "Jersey Signed by Eli Manning",  699.99);
products[13] = new Product("014", "Cleats Signed by Adrian Peterson",  499.99);
products[14] = new Product("015", "Gloves Signed by Jerome Cunningham",  149.99);
products[15] = new Product("016", "Helmet Signed by Luke Kuechly",  199.99);
products[16] = new Product("017", "Football Signed by Peyton Manning",  599.99);
products[17] = new Product("018", "Jersey Signed by Tom Brady",  1499.99);
